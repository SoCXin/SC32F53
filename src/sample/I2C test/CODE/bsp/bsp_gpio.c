...
{		
		...
		GPIO_SetBits(RGB1_GPIO_PORT,RGB1_GPIO_PIN);   	//默认不亮
		GPIO_SetBits(RGB2_GPIO_PORT,RGB2_GPIO_PIN);   	//默认不亮
		GPIO_SetBits(RGB3_GPIO_PORT,RGB3_GPIO_PIN);   	//默认不亮
		GPIO_SetBits(LED2_GPIO_PORT,LED2_GPIO_PIN);   	//默认不亮
}
